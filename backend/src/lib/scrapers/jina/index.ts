import { Business, SocialProfile } from '../../../types';
 ...
 */
function extractSocials(text: string, url: string): SocialProfile[] {
 ...
 */
export async function searchWithJina(query: string): Promise<Business[]> {
...
/**
 * Scraper interface for future scrapers
 */
export interface Scraper {
  name: string;
  search: (query: string) => Promise<Business[]>;
}

export const jinaScraper: Scraper = {
  name: 'jina',
